...
RSpec.describe Lutaml::Qea::Validation::ValidationResult do
  ...
  describe "filtering methods" do
    ...
    describe "#errors" do
      it "returns only error messages" do
    ...
    describe "#warnings" do
      it "returns only warning messages" do
  ...
  describe "grouping methods" do
    ...
    describe "#grouped_by_category" do
      it "groups messages by category" do
    ...
    describe "#grouped_by_entity_type" do
      it "groups messages by entity type" do
  ...
  describe "#merge!" do
    it "merges another result into this one" do
